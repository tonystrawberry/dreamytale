...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h1: ({ children }) => <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tighter">{children}</h1>,
    h2: ({ children }) => <h2 className="text-3xl md:text-4xl font-bold my-4 tracking-tighter">{children}</h2>,
